...
#ifndef INC_142_GUCLUGEMI_H
#define INC_142_GUCLUGEMI_H
#include "Gemi.h"
...
protected:
    ...
    double Kolasilik=0.5;
    double Holasilik=0.5;//2 kat daha az şansı var dediğinizin bu olduğunu düşündüm


};

#endif //INC_142_GUCLUGEMI_H
